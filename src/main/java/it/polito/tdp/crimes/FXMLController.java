...
public class FXMLController {
    ...
    void doCalcolaPercorso(ActionEvent event) {
    	...
    	LinkedList<String> percorso = new LinkedList<String> (this.model.trovaPercorso(arco.getV1(), arco.getV2()));
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(cat == null || mese == null) {
    		txtResult.appendText("Seleziona i valori di imput");
    		return;
    	}
    	...
    	LinkedList<Adiacenza> archi = new LinkedList<>(this.model.getArchi());
